  ...
  getFooter?: {
    ...
    data: Array<{
      ...
      footerLinks?: Array<{
        __typename?: 'FooterLinks'
        name: string
        links?: Array<{ __typename?: 'Links'; name: string; href: string }> | null
      }> | null
...
export type GetHeaderQuery = {
  ...
  getHeader?: {
    ...
    data: Array<{
      ...
      loginBtn: { __typename?: 'Link'; name: string; href: string }
      startHereBtn: { __typename?: 'Link'; name: string; href: string }
    } | null>
  } | null
}
...
export type FooterLinksResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['FooterLinks'] = ResolversParentTypes['FooterLinks'],
> = {
